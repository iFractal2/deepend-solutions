 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(C,b){var P=C.length;C.push(b);e:for(;0<P;){var H=P-1>>>1,G=C[H];if(0<l(G,b))C[H]=b,C[P]=G,P=H;else break e}}function n(C){return C.length===0?null:C[0]}function r(C){if(C.length===0)return null;var b=C[0],P=C.pop();if(P!==b){C[0]=P;e:for(var H=0,G=C.length,qn=G>>>1;H<qn;){var gt=2*(H+1)-1,yl=C[gt],vt=gt+1,er=C[vt];if(0>l(yl,P))vt<G&&0>l(er,yl)?(C[H]=er,C[vt]=P,H=vt):(C[H]=yl,C[gt]=P,H=gt);else if(vt<G&&0>l(er,P))C[H]=er,C[vt]=P,H=vt;else break e}}return b}function l(C,b){var P=C.sortIndex-b.sortIndex;return P!==0?P:C.id-b.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var i=Date,a=i.now();e.unstable_now=function(){return i.now()-a}}var s=[],c=[],v=1,g=null,m=3,y=!1,h=!1,w=!1,z=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,u=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(C){for(var b=n(c);b!==null;){if(b.callback===null)r(c);else if(b.startTime<=C)r(c),b.sortIndex=b.expirationTime,t(s,b);else break;b=n(c)}}function x(C){if(w=!1,f(C),!h)if(n(s)!==null)h=!0,gl(k);else{var b=n(c);b!==null&&vl(x,b.startTime-C)}}function k(C,b){h=!1,w&&(w=!1,d(j),j=-1),y=!0;var P=m;try{for(f(b),g=n(s);g!==null&&(!(g.expirationTime>b)||C&&!je());){var H=g.callback;if(typeof H=="function"){g.callback=null,m=g.priorityLevel;var G=H(g.expirationTime<=b);b=e.unstable_now(),typeof G=="function"?g.callback=G:g===n(s)&&r(s),f(b)}else r(s);g=n(s)}if(g!==null)var qn=!0;else{var gt=n(c);gt!==null&&vl(x,gt.startTime-b),qn=!1}return qn}finally{g=null,m=P,y=!1}}var N=!1,E=null,j=-1,V=5,T=-1;function je(){return!(e.unstable_now()-T<V)}function sn(){if(E!==null){var C=e.unstable_now();T=C;var b=!0;try{b=E(!0,C)}finally{b?un():(N=!1,E=null)}}else N=!1}var un;if(typeof u=="function")un=function(){u(sn)};else if(typeof MessageChannel<"u"){var Mi=new MessageChannel,uc=Mi.port2;Mi.port1.onmessage=sn,un=function(){uc.postMessage(null)}}else un=function(){z(sn,0)};function gl(C){E=C,N||(N=!0,un())}function vl(C,b){j=z(function(){C(e.unstable_now())},b)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(C){C.callback=null},e.unstable_continueExecution=function(){h||y||(h=!0,gl(k))},e.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):V=0<C?Math.floor(1e3/C):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(C){switch(m){case 1:case 2:case 3:var b=3;break;default:b=m}var P=m;m=b;try{return C()}finally{m=P}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(C,b){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var P=m;m=C;try{return b()}finally{m=P}},e.unstable_scheduleCallback=function(C,b,P){var H=e.unstable_now();switch(typeof P=="object"&&P!==null?(P=P.delay,P=typeof P=="number"&&0<P?H+P:H):P=H,C){case 1:var G=-1;break;case 2:G=250;break;case 5:G=1073741823;break;case 4:G=1e4;break;default:G=5e3}return G=P+G,C={id:v++,callback:b,priorityLevel:C,startTime:P,expirationTime:G,sortIndex:-1},P>H?(C.sortIndex=P,t(c,C),n(s)===null&&C===n(c)&&(w?(d(j),j=-1):w=!0,vl(x,P-H))):(C.sortIndex=G,t(s,C),h||y||(h=!0,gl(k))),C},e.unstable_shouldYield=je,e.unstable_wrapCallback=function(C){var b=m;return function(){var P=m;m=b;try{return C.apply(this,arguments)}finally{m=P}}}})(as);is.exports=as;var Rc=is.exports;/**
 * @license React
...
- Phone:
- City:
`);window.location.href=`mailto:deepend.service@deependpoolsolutions.com?subject=${o}&body=${i}`};return p.jsxs("div",{style:{fontFamily:"Oswald, system-ui, -apple-system, Segoe UI, Roboto, Arial, sans-serif",color:"#112434",background:"#ffffff"},children:[p.jsx("style",{children:sc}),p.jsxs("section",{className:"winter-hero",children:[p.jsx("div",{className:"winter-hero__bg"}),p.jsxs("div",{className:"container winter-hero__inner",children:[p.jsx("h1",{className:"winter-hero__title",children:"Deep End Support"}),p.jsx("p",{className:"winter-hero__dek",children:"Tell us what’s going on, and we’ll guide you to a fix."})]})]}),p.jsx("div",{className:"container winter-lead fade-on-view",children:p.jsxs("figure",{className:"winter-lead__figure",children:[p.jsxs("div",{className:"winter-lead__img",role:"img","aria-label":"Winter chemistry visual",children:[e?p.jsx("img",{className:"winter-lead__photo",src:e,alt:"LSI background"}):null,p.jsx("div",{className:"winter-lead__scrim"})]}),p.jsx("figcaption",{className:"winter-lead__cap",children:"Recently had your water tested? Get a free comprehensive analysis right at home!"})]})}),p.jsxs("section",{className:"container winter-search fade-on-view",children:[p.jsx("h2",{className:"winter-search__headline",children:"What's your problem!?"}),p.jsx("p",{className:"winter-search__sub",children:"We can help..."}),p.jsxs("form",{className:"winter-search__form",onSubmit:r,role:"search","aria-label":"Describe your pool issue",children:[p.jsxs("div",{className:"winter-search__field",children:[p.jsx("input",{type:"text",value:t,onChange:l=>n(l.target.value),placeholder:"e.g., pH keeps drifting up, heater scaling, plaster dust, metals, cloudy water...","aria-label":"Describe your issue"}),p.jsx("button",{type:"submit","aria-label":"Send",children:"Get help"})]}),p.jsxs("div",{className:"winter-search__chips","aria-hidden":"true",children:[p.jsx("span",{onClick:()=>n("Low LSI / etching risk in cold water"),children:"LSI/etching"}),p.jsx("span",{onClick:()=>n("White scale forming on tile line or heater"),children:"Scale"}),p.jsx("span",{onClick:()=>n("SWG stopped producing chlorine in cold temps"),children:"SWG & cold"}),p.jsx("span",{onClick:()=>n("How to set pH/TA/CH for winter balance"),children:"Target levels"}),p.jsx("span",{onClick:()=>n("Stain or metal issues over the winter"),children:"Stains/Metals"})]})]})]}),p.jsx("footer",{className:"winter-footer",children:p.jsx("div",{className:"container winter-footer__inner",children:p.jsxs("p",{className:"winter-footer__txt",children:["Prefer to chat? Email ",p.jsx("a",{href:"mailto:deepend.service@deependpoolsolutions.com",children:"deepend.service@deependpoolsolutions.com"})," or call ",p.jsx("a",{href:"tel:+18175643400",children:"817-564-3400"}),"."]})})})]})}function bp({data:e,theme:t,refFn:n,hidden:r,onOpen:l}){const[o,i]=I.useState(null);return I.useEffect(()=>{i(Oi(e.prefix||e.key))},[e.prefix,e.key]),p.jsxs("a",{className:`service ${r?"service--hidden":""}`,href:"#",ref:n,onClick:a=>{a.preventDefault(),l()},"aria-label":`Open ${e.title}`,children:[p.jsxs("div",{className:"service__thumb",children:[o&&p.jsx("img",{src:o,alt:`${e.title} preview`,style:{width:"100%",height:"100%",objectFit:"cover",position:"absolute",top:0,left:0,right:0,bottom:0,zIndex:0},onError:a=>{a.currentTarget.style.display="none"}}),p.jsx("div",{style:{position:"absolute",bottom:0,left:0,right:0,height:"50%",background:`linear-gradient(to top, ${t.end}f0 0%, ${t.end}cc 30%, transparent 100%)`,zIndex:1}})]}),p.jsxs("div",{className:"service__title",style:{position:"absolute",bottom:0,left:0,right:0,zIndex:2,padding:"18px 20px",fontWeight:800,color:"#fff",textShadow:"0 2px 8px rgba(0,0,0,.5), 0 1px 3px rgba(0,0,0,.3)",fontSize:"clamp(17px, 2.6vw, 22px)",background:"linear-gradient(to top, rgba(0,0,0,.4) 0%, rgba(0,0,0,.2) 100%)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"space-between"},children:[p.jsx("span",{children:e.title}),p.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",style:{opacity:.9,transition:"transform 0.3s ease"},className:"service__arrow",children:p.jsx("polyline",{points:"9 18 15 12 9 6"})})]})]})}function Pp({title:e,body:t,prefix:n,tint:r=["#0b63c8","#13909e"],active:l,setActive:o}){const[i,a]=I.useState(null);I.useEffect(()=>a(Oi(n)),[n]);const s=l===n,c=()=>o(g=>g===n?null:n),v=g=>{(g.key==="Enter"||g.key===" ")&&(g.preventDefault(),c())};return p.jsxs("article",{className:`rcard ${s?"rcard--open":""}`,onClick:c,onKeyDown:v,tabIndex:0,role:"button","aria-expanded":s,"aria-label":`${e} details`,children:[p.jsxs("div",{className:"rcard__media","aria-hidden":"true",children:[i?p.jsx("img",{src:i,alt:""}):p.jsx("div",{className:"rcard__ph",children:"Image coming soon"}),p.jsx("div",{className:"rcard__tint",style:{background:`linear-gradient(135deg, ${r[0]}, ${r[1]})`}})]}),p.jsxs("div",{className:"rcard__cover",children:[p.jsx("h4",{className:"rcard__title",children:e}),p.jsx("p",{className:"rcard__text",children:t})]})]})}function Lp(){const[e,t]=I.useState(null),n=I.useRef(null),r=I.useRef([]),l=[{title:"Retail",key:"retail",text:"If you're looking for chemicals, parts, or pool toys, we've got you covered! Our retail department is fully stocked with top-quality products...",tint:["#13909e","#22c1d6"]},{title:"Repair",key:"repair",text:"Trouble with your pool equipment? No problem! Our expert repair team specializes in all types of pool equipment...",tint:["#0b63c8","#13909e"]},{title:"Maintenance",key:"maintenance",text:"Keeping your pool healthy and inviting takes consistent care, and that's where our maintenance team shines...",tint:["#0a1040","#0b63c8"]}];I.useEffect(()=>{const i=n.current;if(!i)return;const a=()=>{const c=document.createElement("div");c.className="ambient-bubble";const v=Math.random()*50+30;c.style.width=`${v}px`,c.style.height=`${v}px`;const g=Math.random()*100;c.style.left=`${g}%`;const m=(Math.random()-.5)*80;c.style.setProperty("--drift",`${m}px`);const y=Math.random()*4+4;c.style.animationDuration=`${y}s`;const h=Math.random()*.35+.15;c.style.opacity=h,i.appendChild(c),setTimeout(()=>{c.parentNode&&c.remove()},y*1e3)};for(let c=0;c<35;c++)setTimeout(()=>a(),c*150);const s=setInterval(a,300);return()=>{clearInterval(s)}},[]),I.useEffect(()=>{const i=n.current;if(!i)return;let a=0;const s=40,c=v=>{const g=Date.now();if(g-a<s)return;a=g;const m=i.getBoundingClientRect(),y=v.clientX-m.left,h=v.clientY-m.top;if(y<0||h<0||y>m.width||h>m.height)return;const w=Math.floor(Math.random()*2)+2;for(let z=0;z<w;z++){const d=document.createElement("div");d.className="cursor-bubble";const u=Math.random()*6+5;d.style.width=`${u}px`,d.style.height=`${u}px`;const f=(Math.random()-.5)*20,x=(Math.random()-.5)*20;d.style.left=`${y+f}px`,d.style.top=`${h+x}px`;const k=Math.random(),N=Math.random();d.style.setProperty("--random-x",k),d.style.setProperty("--random-y",N),i.appendChild(d),r.current.push(d),setTimeout(()=>{d.parentNode&&d.remove(),r.current=r.current.filter(E=>E!==d)},1500)}};return i.addEventListener("mousemove",c),()=>{i.removeEventListener("mousemove",c),r.current.forEach(v=>{v.parentNode&&v.remove()}),r.current=[]}},[]);const o=Oi("poolwerx");return p.jsx("div",{className:"resources",ref:n,children:p.jsxs("div",{className:"container",children:[p.jsx("h3",{className:"resources-title",children:"You've reached The Deep End..."}),p.jsx("div",{className:"resources-cards",children:l.map(i=>p.jsx(Pp,{title:i.title,body:i.text,prefix:i.key,tint:i.tint,active:e,setActive:t},i.key))}),p.jsxs("p",{className:"resources-cta",children:["For more information regarding your Retail/Repair/Maintenance needs:",p.jsx("br",{}),p.jsx("a",{className:"resources-cta-link",href:"https://www.poolwerx.com/",target:"_blank",rel:"noopener noreferrer","aria-label":"Click here for more information regarding Retail, Repair, and Maintenance",children:"poolwerx.com"}),p.jsx("br",{}),p.jsx("a",{href:"tel:+19729629119",className:"resources-cta-sub",style:{textDecoration:"none",color:"inherit"},children:"972-962-9119"}),p.jsx("br",{}),p.jsx("a",{href:"mailto:deepend@poolwerx.com",className:"resources-cta-sub",style:{textDecoration:"none",color:"inherit"},children:"deepend@poolwerx.com"})]}),p.jsxs("div",{className:"locations-section",children:[p.jsx("h3",{className:"locations-title",children:"Come visit one of our locations!"}),p.jsxs("div",{className:"locations-buttons",children:[p.jsx("a",{href:"https://share.google/xGXV4dUcI8H6hXbDe",target:"_blank",rel:"noopener noreferrer",className:"location-btn",children:"North Richland Hills"}),p.jsx("a",{href:"https://share.google/qS8aTDJFJ1t4ETdpn",target:"_blank",rel:"noopener noreferrer",className:"location-btn",children:"Roanoke"}),p.jsx("a",{href:"https://share.google/56BInjZxxwXl6ow54",target:"_blank",rel:"noopener noreferrer",className:"location-btn",children:"Lantana"}),p.jsx("a",{href:"https://share.google/95HyIZKhxfc67PTFt",target:"_blank",rel:"noopener noreferrer",className:"location-btn",children:"Flower Mound"})]})]}),p.jsxs("div",{className:"poweredby",children:[p.jsx("div",{className:"poweredby__text",children:"Powered by:"}),o?p.jsx("div",{className:"poweredby__chip",children:p.jsx("img",{className:"poweredby__logo",src:o,alt:"Poolwerx"})}):null]})]})})}function Tp({service:e,theme:t,summary:n,fromRect:r,onClose:l}){const o=I.useRef(null),[i,a]=I.useState([]),[s,c]=I.useState(0),v=I.useRef(null),g=I.useRef(0),m=I.useRef(0);I.useEffect(()=>{const h=ac(e.prefix);a(h.length?h:[])},[e.prefix]),I.useEffect(()=>{if(i.length)return v.current=setInterval(()=>c(h=>(h+1)%i.length),3500),()=>{v.current&&clearInterval(v.current)}},[i]),I.useEffect(()=>{const h=w=>{w.key==="ArrowLeft"?c(z=>(z-1+i.length)%i.length):w.key==="ArrowRight"?c(z=>(z+1)%i.length):w.key==="Escape"&&l()};return window.addEventListener("keydown",h),()=>window.removeEventListener("keydown",h)},[i.length,l]),I.useLayoutEffect(()=>{const h=o.current;if(!h||!r)return;const w=h.getBoundingClientRect(),z={x:r.x,y:r.y,w:r.w,h:r.h},d=z.w/w.width,u=z.h/w.height,f=z.x-w.x,x=z.y-w.y,k=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;if("animate"in h&&!k){h.animate([{opacity:0,backdropFilter:"blur(0px)"},{opacity:1,backdropFilter:"blur(10px)"}],{duration:400,easing:"cubic-bezier(0.16, 1, 0.3, 1)",fill:"both"}),h.style.transformOrigin="top left";const E=h.querySelector(".expanded");E?E.animate([{transform:`translate(${f}px, ${x}px) scale(${d}, ${u})`,opacity:.8,borderRadius:"16px"},{transform:"translate(0, 0) scale(1, 1)",opacity:1,borderRadius:"16px"}],{duration:450,easing:"cubic-bezier(0.16, 1, 0.3, 1)",fill:"both"}):h.animate([{transform:`translate(${f}px, ${x}px) scale(${d}, ${u})`},{transform:"translate(0, 0) scale(1, 1)"}],{duration:450,easing:"cubic-bezier(0.16, 1, 0.3, 1)",fill:"both"});const j=h.querySelector(".expanded");j&&j.animate([{opacity:0,transform:"translateY(6px)"},{opacity:1,transform:"translateY(0)"}],{duration:260,delay:90,easing:"cubic-bezier(.2,.8,.2,1)",fill:"both"})}else h.classList.add("flip-fallback-in"),requestAnimationFrame(()=>h.classList.add("flip-fallback-in--play"))},[r]);const y=()=>{const h=o.current;if(!h||!r)return l();const w=h.getBoundingClientRect(),z={x:r.x,y:r.y,w:r.w,h:r.h},d=z.w/w.width,u=z.h/w.height,f=z.x-w.x,x=z.y-w.y,k=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;if("animate"in h&&!k){h.animate([{opacity:1,backdropFilter:"blur(10px)"},{opacity:0,backdropFilter:"blur(0px)"}],{duration:300,easing:"cubic-bezier(0.4, 0, 1, 1)",fill:"forwards"});const E=h.querySelector(".expanded");E?E.animate([{transform:"scale(1)",opacity:1},{transform:"scale(0.95)",opacity:0}],{duration:300,easing:"cubic-bezier(0.4, 0, 1, 1)",fill:"forwards"}).finished.finally(l).catch(l):(h.style.transformOrigin="top left",h.animate([{transform:"translate(0,0) scale(1,1)"},{transform:`translate(${f}px, ${x}px) scale(${d}, ${u})`}],{duration:300,easing:"cubic-bezier(0.4, 0, 1, 1)",fill:"forwards"}).finished.finally(l).catch(l))}else h.classList.remove("flip-fallback-in--play"),setTimeout(l,220)};return p.jsx("div",{ref:o,className:"expanded-overlay",onClick:h=>{h.target===h.currentTarget&&y()},children:p.jsxs("div",{className:"expanded",style:{background:`linear-gradient(160deg, ${t.start} 0%, ${t.end} 100%)`,color:"#fff"},onClick:h=>h.stopPropagation(),children:[p.jsx("button",{className:"close","aria-label":"Close",onClick:y,children:"×"}),p.jsx("div",{className:"expanded__header",children:p.jsx("h3",{children:e.title})}),p.jsxs("div",{className:"expanded__content",children:[i.length>0?p.jsxs("div",{className:"slider","data-count":`${s+1} / ${i.length}`,onTouchStart:h=>{g.current=h.touches[0].clientX},onTouchMove:h=>{m.current=h.touches[0].clientX},onTouchEnd:()=>{const h=g.current-m.current;Math.abs(h)>50&&(h>0?c(z=>(z+1)%i.length):c(z=>(z-1+i.length)%i.length)),g.current=0,m.current=0},children:[p.jsx("ul",{className:"slider__track",style:{transform:`translate3d(${-s*100}%,0,0)`},children:i.map((h,w)=>p.jsx("li",{className:"slider__slide",children:p.jsx("img",{src:h,alt:`${e.title} ${w+1}`,draggable:"false"})},`${h}-${w}`))}),p.jsx("button",{className:"nav prev","aria-label":"Previous",onClick:()=>c(h=>(h-1+i.length)%i.length),children:"❮"}),p.jsx("button",{className:"nav next","aria-label":"Next",onClick:()=>c(h=>(h+1)%i.length),children:"❯"})]}):p.jsx("div",{className:"slider",style:{display:"grid",placeItems:"center",padding:16},children:p.jsx("div",{className:"slider__slide",style:{width:"100%"},children:p.jsx("div",{style:{width:"100%",height:"100%",display:"grid",placeItems:"center",aspectRatio:"16/9",background:"#eef3f8",color:"#4a5b6a"},children:"No images available"})})}),p.jsxs("div",{className:"expanded__text",children:[p.jsx("p",{children:n}),p.jsx("p",{style:{color:"#607185",fontSize:"clamp(13px, 1.8vw, 15px)",fontStyle:"italic"},children:"Images show examples of our work; your project may vary. Please contact us with an inquiry. We accommodate."})]})]})]})})}const sc=`
